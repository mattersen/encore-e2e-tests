...
INVALID_CREDS = {
    "blank_username": ("", "SomeValidPassword1!", "Please enter a valid email address."),
    ...
    "blank_password": ("validUser@authtest.com", "", "Please enter your password."),
    "blank_both": ("", "", {"username": "Please enter a valid email address.", "password": "Please enter your password."}),
    "malformed_username": ("notanemail", "SomeValidPassword1!", "Please enter a valid email address.")
}
